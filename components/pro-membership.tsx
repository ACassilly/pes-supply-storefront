          ...
          <div className="flex-1">
            ...
            <div className="mt-8 flex items-center gap-4 rounded-lg border border-border bg-card p-4">
              ...
              <div>
                ...
                <p className="mt-0.5 text-xs text-muted-foreground">Our team picks, packs, and supports every order.</p>
              </div>
            </div>
          </div>
          ...
          <div className="w-full rounded-xl border border-border bg-card p-6 lg:w-[400px] lg:p-8">
            {submitted ? (
              <div className="flex flex-col items-center justify-center py-8 text-center">
                ...
                <p className="mt-2 text-sm text-muted-foreground">Our Louisville team will reach out within 1 business day. Check your email at <strong className="text-card-foreground">{form.email}</strong>.</p>
