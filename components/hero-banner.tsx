...
const slides = [
  ...
  {
    title: "40,000+ Products In Stock",
    subtitle: "Lighting, electrical, tools, HVAC, plumbing, solar, and more.",
    highlight: "Free Shipping on $999+",
  ...
  },
  {
    ...
    subtitle: "Contractor pricing, same-day shipping, and a real team in Portland.",
    highlight: "Pro Accounts Available",
