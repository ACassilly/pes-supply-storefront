...
function ProductCard({ product }: { product: (typeof products)[0] }) {
  ...
  return (
    <div className="group flex flex-col overflow-hidden rounded-lg border border-border bg-card transition-all hover:border-primary/30 hover:shadow-lg">
      <a href="#" className="relative aspect-square w-full overflow-hidden bg-muted">
      ...
      <div className="flex flex-1 flex-col p-3">
        ...
        <a href="#" className="mb-1 line-clamp-2 text-sm font-semibold leading-snug text-card-foreground group-hover:text-primary">{product.name}</a>
