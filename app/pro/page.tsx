...
const benefits = [
  ...
  { icon: Headphones, title: "Account Management", short: "Personalized business shopping experience from start to finish with your account manager.", detail: "Upon creating your business account, we assign you a dedicated Account Manager. Their name and direct contact info appear on your dashboard every time you log in. Your rep handles quotes, sourcing, order issues, and can proactively suggest alternatives when items are backordered." },
  { icon: Truck, title: "Managed Fulfillment", short: "Same-day order processing. Free freight on qualified orders over $999.", detail: "Portlandia Logistics coordinates every shipment, routing orders from the nearest manufacturer DC or stocking partner. Orders placed by 2 PM ET are processed same day. LTL freight quotes are generated at checkout -- no 'call for pricing.' Parcel, LTL, FTL, intermodal, and expedited options available." },
